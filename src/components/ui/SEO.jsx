...
const SEO_DATA = {
  ...
  'taasa-rice': {
    ...
    canonical: 'https://taasabusinessgroup.com/company/taasa-rice',
  ...
  'taasa-trading': {
    ...
    canonical: 'https://taasabusinessgroup.com/company/taasa-trading',
  ...
  'taasa-packaging': {
    ...
    canonical: 'https://taasabusinessgroup.com/company/taasa-packaging',
  ...
  'taasa-guestinn': {
    ...
    canonical: 'https://taasabusinessgroup.com/company/taasa-guestinn',
  ...
  'taasa-resort': {
    ...
    canonical: 'https://taasabusinessgroup.com/company/taasa-resort',
