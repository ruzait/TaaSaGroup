...
import { Home, Check, Coffee, Wifi, Utensils, Car } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="#rooms" className="font-cursive text-white">Rooms</Link>
            <Link to="#amenities" className="font-cursive text-white">Amenities</Link>
            ...
            <Link to="#contact" className="px-6 py-2 rounded-full font-cursive" style={{ backgroundColor: COLORS.accent, color: '#662222' }}>Contact</Link>
          </div>
        </div>
